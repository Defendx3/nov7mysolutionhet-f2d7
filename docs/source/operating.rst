[nov7mysolutionhet-f2d7] Operating Details
====================================

Generated On: 2024-11-07 18:44:29 UTC
...
.. important::
   ...
   **not be valid if your [nov7mysolutionhet-f2d7] container is NOT running**.

.. tip::
   You must have your [nov7mysolutionhet-f2d7] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Defendx3/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=42073  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Defendx3'  \-\-env DOCKERUSERNAME='defendx'  \-\-env MQTTUSERNAME='defendx3@gmail.com'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   defendx/nov7mysolutionhet-f2d7-amd64 (https://hub.docker.com/r/defendx/nov7mysolutionhet-f2d7-amd64)
...
.. important::
   docker run -d -p 48507:48507 -p 33775:33775 -p 35087:35087 \-\-env TSS=0 \-\-env SOLUTIONNAME=nov7mysolutionhet-f2d7 \-\-env SOLUTIONDAG=solution_preprocessing_dag-nov7mysolutionhet-f2d7 \-\-env GITUSERNAME=Defendx3  \-\-env GITREPOURL=https://github.com/Defendx3/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=48507  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=33775  \-\-env SOLUTIONVIPERVIZPORT=35087 \-\-env DOCKERUSERNAME='defendx'  \-\-env EXTERNALPORT=42073 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='defendx3@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  defendx/nov7mysolutionhet-f2d7-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=35087
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=48507
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - defendx/nov7mysolutionhet-f2d7-amd64
...
It can be accessed by entering: http://localhost:33775
...
.. important::
   http://localhost:35087/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:35087/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:35087/<html file>
...
[nov7mysolutionhet-f2d7] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Defendx3/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/nov7mysolutionhet-f2d7
...
.. important::
   https://nov7mysolutionhet-f2d7.readthedocs.io
...
.. important::
   solution_preprocessing_dag-nov7mysolutionhet-f2d7
...
.. important::
   VIPERHOST_PRODUCE=172.17.0.1, VIPERPORT_PRODUCE=48507, VIPERHOST_PREPOCESS=172.17.0.1, VIPERPORT_PREPROCESS=45087, VIPERHOST_PREPOCESS2=172.17.0.1, VIPERPORT_PREPROCESS2=43211, VIPERHOST_PREPOCESS_PGPT=172.17.0.1, VIPERPORT_PREPROCESS_PGPT=35567, VIPERHOST_ML=172.17.0.1, VIPERPORT_ML=38799, VIPERHOST_PREDCT=172.17.0.1, VIPERPORT_PREDICT=37025, HPDEHOST=172.17.0.1, HPDEPORT=41685, HPDEHOST_PREDICT=172.17.0.1, HPDEPORT_PREDICT=40321

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-8116-nov7mysolutionhet-f2d7,solution_preprocessing_dag-nov7mysolutionhet-f2d7, python-preprocess-9643-nov7mysolutionhet-f2d7,solution_preprocessing_dag-nov7mysolutionhet-f2d7, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
